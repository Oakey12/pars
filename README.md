...
В Excel используются те же данные, а также дата и время опроса, расположение,
инвентарный и серийный номера, HTTP-страница и текст диагностических сообщений.
Первая строка закреплена, в заголовках включены фильтры, счётчики хранятся как
числа, а остаток расходника — как числовой процент.
